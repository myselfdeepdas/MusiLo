...
public class PlaySong extends AppCompatActivity {
    ...
    ImageView play, previous, next ,forward, backward, setLoop, setShuffle,back,slist;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slist=findViewById(R.id.list);
        mydialog= new Dialog(PlaySong.this);
        back.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent myIntent=new Intent(PlaySong.this,HomeActivity.class);
    ...
    mydialog.setContentView(R.layout.aboutm);
